...
static void accumulateCoupledContacts(const Contact* contact, const JBlock& JM0inv, const RigidBody* body, Eigen::Vector3f& x) {
...
#pragma omp for schedule(static)
        ...
        for(int iter = 0; iter < m_maxIter; ++iter)
        {
            ...
            for(int i = 0; i < numContacts; ++i)
            {
                ...
                /*std::cout << ct->J0Minv << std::endl;
                std::cout << ct->J1Minv << std::endl;
                std::cout << ct->J0 << std::endl;
                std::cout << ct->J1 << std::endl;
